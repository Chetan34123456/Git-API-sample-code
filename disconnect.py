...
# functions
def disconnectWorkspace(workspaceId : str):
    '''
    Disconnects workspace from Azure Devops Repo
    
    params : str workspaceId -> workspace id of Fabric workspace
    '''
    url = f'https://api.fabric.microsoft.com/v1/workspaces/{workspaceId}/git/disconnect'
...
disconnectWorkspace('9f06650a-4b74-42c4-bf0d-9cd7d5d6b140')
