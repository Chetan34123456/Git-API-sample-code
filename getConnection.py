...
---------------- Scopes -----------------------
Workspace.Read.All or Workspace.ReadWrite.Al
'''
...
def getStatus(workspaceId : str):
    '''
    Return git connection details of a specific workspace
    
    params : str workspaceId -> workspace id of Fabric workspace
    '''
    url = f'https://api.fabric.microsoft.com/v1/workspaces/{workspaceId}/git/connection'
